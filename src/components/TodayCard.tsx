      ...
      <View style={styles.row}>
        <View style={styles.team}>
          {team1Flag ? (
            ...
            <View style={[styles.teamAvatar, styles.teamAvatarFallback, { backgroundColor: '#8b5cf6' }]}>
        ...
        <View style={styles.team}>
          {team2Flag ? (
            ...
            <View style={[styles.teamAvatar, styles.teamAvatarFallback, { backgroundColor: '#ec4899' }]}>
